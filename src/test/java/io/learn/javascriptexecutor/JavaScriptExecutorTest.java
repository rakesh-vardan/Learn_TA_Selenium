package io.learn.javascriptexecutor;
...
public class JavaScriptExecutorTest extends BaseTest {
    ...
    public void testInfiniteScroll() {
        ...
        assertThat(initialParagraphSize).isEqualTo(20);
    ...
    public void testColorPicker() {
        ...
        String script = String.format("arguments[0].setAttribute('value', '%s');", redColor.asHex()); // #ff00000
